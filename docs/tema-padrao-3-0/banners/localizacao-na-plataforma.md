...
* **Banner Home Mobile:** Representa os banners principais da loja para a versão mobile, seguindo o mesmo modelo da versão desktop.
...
::: danger **Atenção**
O cadastro dos banners como Banner Galeria não está disponível no Tema Padrão Bagy 3.0. Caso seja cadastrado, o mesmo não será exibido na loja
:::

::: danger Observação:
Os banners precisam estar nomeados corretamente, caso contrário a plataforma não conseguirá reconhecer. Utilize [**essa ferramenta**](https://textedit.tools/slugify) para gerar nomes dos arquivos compatíveis com a plataforma.
:::
