...
**Layout**: Define se a exibição dos produtos na vitrine serão em **Grid** ou **Carrossel**.

**Quantidade de produtos:** Define quantos produtos serão exibidos na vitrine. Você pode optar por 4, 8, 12 ou 16 produtos por vitrine.
...
Caso a imagem do produto na vitrine esteja menor do que no tema demonstrativo, acesse [aqui](../../configuracoes/tamanho-da-vitrine) para maiores detalhes
:::
